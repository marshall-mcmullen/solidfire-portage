...
SRC_URI="https://bitbucket.org/solidfire/${MY_PN}/get/v${PV}.tar.bz2 -> ${P}.tar.bz2"
...
src_compile()
{
	emake HEALTHTOOLS_VERSION=${PV} setup
    emake HEALTHTOOLS_VERSION=${PV} build_all_components
    emake HEALTHTOOLS_VERSION=${PV} package_tarball
}
